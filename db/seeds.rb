...
taylan = User.create!(username:"taylan", password: "123", bio: "get me a whiteboard",image_url: "https://ca.slack-edge.com/T02MD9XTF-U041GHXMKGF-979daf35b057-192")
...
t_post = Post.create!(body:"Not very good at All at League of Legends", user_id:taylan.id)

a_comment = Comment.create!(text:"😍", user_id:aaron.id, post_id:a_post.id)
